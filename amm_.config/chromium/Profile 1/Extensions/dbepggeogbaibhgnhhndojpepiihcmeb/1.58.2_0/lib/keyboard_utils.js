...
(function() {
  ...
  KeyboardUtils = {
    ...
    isEscape: (function() {
      ...
      return function(event) {
        return event.keyCode === this.keyCodes.ESC || (function(_this) {
          return function() {
            var keyChar, ref;
            keyChar = _this.getKeyCharString(event, true);
    ...
    getKeyCharString: function(event, allKeydownEvents) {
      var keyChar, modifiers;
      if (allKeydownEvents == null) {
        allKeydownEvents = false;
      }
      switch (event.type) {
        case "keypress":
          if (31 < event.keyCode) {
        ...
        case "keydown":
          ...
          if (1 < keyChar.length || (keyChar.length === 1 && (event.metaKey || event.ctrlKey || event.altKey)) || allKeydownEvents) {
            modifiers = [];
            if (event.shiftKey) {
