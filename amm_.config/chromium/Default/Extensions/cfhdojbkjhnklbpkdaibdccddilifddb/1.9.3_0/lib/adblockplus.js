...
require.scopes["matcher"] = (function()
{
  ...
  Matcher.prototype = {
    ...
    matchesAny: function(location, typeMask, docDomain, thirdParty, sitekey)
    {
      ...
      for (var i = 0, l = candidates.length; i < l; i++)
      {
        ...
        {
          var result = this._checkEntryMatch(substr, location, typeMask, docDomain, thirdParty, sitekey);
          if (result)
          {
            return result;
          }
  ...
  CombinedMatcher.prototype = {
    ...
    matchesAny: function(location, typeMask, docDomain, thirdParty, sitekey)
    {
      var key = location + " " + typeMask + " " + docDomain + " " + thirdParty + " " + sitekey;
      if (key in this.resultCache)
      {
        return this.resultCache[key];
      }
      var result = this.matchesAnyInternal(location, typeMask, docDomain, thirdParty, sitekey);
...
require.scopes["notification"] = (function()
{
  ...
  var _tempVar32 = require("filterClasses");
  var Filter = _tempVar32.Filter;
  var RegExpFilter = _tempVar32.RegExpFilter;
  var INITIAL_DELAY = 1 * MILLIS_IN_MINUTE;
  var CHECK_INTERVAL = 1 * MILLIS_IN_HOUR;
  ...
  var Notification = exports.Notification = {
    ...
    _onDownloadSuccess: function(downloadable, responseText, errorCallback, redirectCallback)
    {
      try
      {
        ...
        for (var _loopIndex33 = 0; _loopIndex33 < data.notifications.length; ++_loopIndex33)
        {
          var notification = data.notifications[_loopIndex33];
      ...
      var _tempVar34 = downloader.processExpirationInterval(EXPIRATION_INTERVAL);
      Prefs.notificationdata.softExpiration = _tempVar34[0];
      Prefs.notificationdata.hardExpiration = _tempVar34[1];
    ...
    _getNextToShow: function(url)
    {
      ...
      for (var _loopIndex36 = 0; _loopIndex36 < notifications.length; ++_loopIndex36)
      {
        var notification = notifications[_loopIndex36];
        ...
        if (typeof url === "string" || notification.urlFilters instanceof Array)
        {
          if (typeof url === "string" && notification.urlFilters instanceof Array)
          {
            ...
            for (var _loopIndex37 = 0; _loopIndex37 < notification.urlFilters.length; ++_loopIndex37)
            {
              var urlFilter = notification.urlFilters[_loopIndex37];
        ...
        {
          var match = false;
          for (var _loopIndex38 = 0; _loopIndex38 < notification.targets.length; ++_loopIndex38)
          {
            var target = notification.targets[_loopIndex38];
    ...
    showNext: function(url)
    {
      ...
      if (notification)
      {
        for (var _loopIndex39 = 0; _loopIndex39 < showListeners.length; ++_loopIndex39)
        {
          var showListener = showListeners[_loopIndex39];
    ...
    getLocalizedTexts: function(notification, locale)
    {
      ...
      var localizedTexts = [];
      for (var _loopIndex40 = 0; _loopIndex40 < textKeys.length; ++_loopIndex40)
      {
        var key = textKeys[_loopIndex40];
    ...
    triggerQuestionListeners: function(id, approved)
    {
      ...
      for (var _loopIndex41 = 0; _loopIndex41 < listeners.length; ++_loopIndex41)
      {
        var listener = listeners[_loopIndex41];
        listener(approved);
      }
    },
...
require.scopes["antiadblockInit"] = (function()
{
  ...
  exports.initAntiAdblockNotification = function initAntiAdblockNotification()
  {
    ...
    {
      var urlFilters = [];
      for (var _loopIndex42 = 0; _loopIndex42 < subscription.filters.length; ++_loopIndex42)
      {
        var filter = subscription.filters[_loopIndex42];
        if (filter instanceof ActiveFilter)
        {
  ...
  window.URL = (function()
  {
    ...
    }))
    {
      ...
      URL = function(url, baseUrl)
      {
        ...
        anchor.href = url;
        for (var _loopIndex43 = 0; _loopIndex43 < URLProperties.length; ++_loopIndex43)
        {
          var prop = URLProperties[_loopIndex43];
...
require.scopes["whitelisting"] = (function()
{
  ...
  var _tempVar44 = require("url");
  var stringifyURL = _tempVar44.stringifyURL;
  var getDecodedHostname = _tempVar44.getDecodedHostname;
  var extractHostFromFrame = _tempVar44.extractHostFromFrame;
  var isThirdParty = _tempVar44.isThirdParty;
  ...
  exports.processKey = function(token, page, frame)
  {
    ...
    var _tempVar45 = token.split("_", 2);
    var key = _tempVar45[0];
    var signature = _tempVar45[1];
    key = key.replace(/=/g, "");
...
require.scopes["filterValidation"] = (function()
{
  ...
  var InvalidFilter = _tempVar46.InvalidFilter;
  var ElemHideBase = _tempVar46.ElemHideBase;
  ...
  exports.parseFilters = function(text)
  {
    ...
    for (var i = 0; i < lines.length; i++)
    {
      var _tempVar47 = parseFilter(lines[i]);
      var filter = _tempVar47.filter;
      var error = _tempVar47.error;
      if (filter)
      {
        filters.push(filter);
      }
...
{
  var exports = {};
  var _tempVar48 = require("url");
  var extractHostFromFrame = _tempVar48.extractHostFromFrame;
  var stringifyURL = _tempVar48.stringifyURL;
  var isThirdParty = _tempVar48.isThirdParty;
  var _tempVar49 = require("whitelisting");
  var getKey = _tempVar49.getKey;
  var isFrameWhitelisted = _tempVar49.isFrameWhitelisted;
  var defaultMatcher = require("matcher").defaultMatcher;
  var RegExpFilter = require("filterClasses").RegExpFilter;
  ...
  exports.composeFilters = function(details)
  {
    ...
    if (!isFrameWhitelisted(page, frame, RegExpFilter.typeMap.DOCUMENT))
    {
      ...
      for (var _loopIndex50 = 0; _loopIndex50 < details.urls.length; ++_loopIndex50)
      {
        var url = details.urls[_loopIndex50];
      ...
      if (filters.length == 0 && !isFrameWhitelisted(page, frame, RegExpFilter.typeMap.ELEMHIDE))
      {
        ...
        for (var _loopIndex51 = 0; _loopIndex51 < selectors.length; ++_loopIndex51)
        {
          var selector = selectors[_loopIndex51];
...
{
  var exports = {};
  var _tempVar52 = require("icon");
  var startIconAnimation = _tempVar52.startIconAnimation;
  var stopIconAnimation = _tempVar52.stopIconAnimation;
  var Utils = require("utils").Utils;
  ...
  function openNotificationLinks()
  {
    ...
    {
      for (var _loopIndex53 = 0; _loopIndex53 < activeNotification.links.length; ++_loopIndex53)
      {
        var link = activeNotification.links[_loopIndex53];
